...
curl -Lo kops https://github.com/kubernetes/kops/releases/download/$ https://api.github.com/repos/kubernetes/kops/releases/latest | grep tag_name | cut -d '"' -f 4)/kops-linux-amd64
